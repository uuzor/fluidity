 ...
 */
contract SecureBorrowerOperations is SecurityBase, IBorrowerOperations {
    ...
    uint256 public constant MIN_ADJUSTMENT_AMOUNT = 1e18; // 1 unit minimum
    
    // Dynamic gas compensation (instead of hardcoded 200e18)
    uint256 public gasCompensation = 200e18;
    ...
    function addColl(address asset, uint256 collAmount, address upperHint, address lowerHint) external payable 
        ...
        antiMEV()
    {
        adjustTrove(asset, 0, 0, 0, false, upperHint, lowerHint);
    }
