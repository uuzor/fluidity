    ...
    IBorrowerOperations 
{
    ...
    uint256 public constant MIN_NET_DEBT = 200e18; // 200 USDF minimum debt (matching SecureBorrowerOperations)
    ...
    function openTrove(
        ...
        require(debtAmount >= MIN_NET_DEBT, "Debt below minimum");
    ...
    function _adjustTrove(
        ...
        if (debtChange > 0) {
            ...
            require(newDebt >= MIN_NET_DEBT, "New debt below minimum");
